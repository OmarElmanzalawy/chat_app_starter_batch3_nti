...
class _ChatBubbleState extends State<ChatBubble> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    slideAnimation = Tween(begin: Offset(isMe ? 0.5 : -0.5, 0),end: Offset.zero).animate(CurvedAnimation(parent: animationController, curve: Curves.easeOutQuart));
            ...
            return AlertDialog(
              ...
              actions: [
                ...
                TextButton(onPressed: ()async{
                  await ChatService.deleteMessege(widget.chatId, widget.model.id, context);
                  Navigator.pop(context);
                }, child: Text("Delete"))
              ],
            );
